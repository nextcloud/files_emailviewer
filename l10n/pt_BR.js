OC.L10N.register(
    ...
    "Please install https://github.com/nickrussler/email-to-pdf-converter and set the path via `%s`" : "Por favor, instale https://github.com/nickrussler/email-to-pdf-converter e configure seu caminho via `%s`",
